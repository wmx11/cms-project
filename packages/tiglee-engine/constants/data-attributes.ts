/**
 * @description Constants for data-attributes used across the project to handle certain behaviors of elements
...
export const DRATA_CANVAS_OVERLAY_DND_HIGHLIGHT = 'data-canvas-dnd-highlight';
