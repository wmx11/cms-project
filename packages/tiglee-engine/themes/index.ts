...
const themes: BuilderThemes = {
  ...
  'neo-violet': {
    light: {
      [BACKGROUND_VAR]: '169 57% 91%',
      [FOREGROUND_VAR]: '260 60% 98%',
      [CARD_VAR]: '20 14.3% 4.1%',
      [CARD_FOREGROUND_VAR]: '260 60% 98%',
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '260 60% 98%',
      [PRIMARY_VAR]: '262 100% 81.57%',
      [PRIMARY_FOREGROUND_VAR]: '260 60% 98%',
      [SECONDARY_VAR]: '262 100% 81.57%',
      [SECONDARY_FOREGROUND_VAR]: '260 60% 98%',
      [MUTED_VAR]: '262 100% 81.57%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '262 100% 81.57%',
      [ACCENT_FOREGROUND_VAR]: '260 60% 98%',
      [DESTRUCTIVE_VAR]: '0 62.8% 30.6%',
      [DESTRUCTIVE_FOREGROUND_VAR]: '260 60% 98%',
      [BORDER_VAR]: '262 100% 81.57%',
      [INPUT_VAR]: '262 100% 81.57%',
      [RING_VAR]: '35.5 91.7% 32.9%',
    },
    dark: {},
  },
  'neo-orange': {
    light: {
      [BACKGROUND_VAR]: '38.71 100% 93.92%',
      [FOREGROUND_VAR]: '260 60% 98%',
      [CARD_VAR]: '20 14.3% 4.1%',
      [CARD_FOREGROUND_VAR]: '260 60% 98%',
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '260 60% 98%',
      [PRIMARY_VAR]: '27 98% 63%',
      [PRIMARY_FOREGROUND_VAR]: '260 60% 98%',
      [SECONDARY_VAR]: '27 98% 63%',
      [SECONDARY_FOREGROUND_VAR]: '260 60% 98%',
      [MUTED_VAR]: '27 98% 63%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '27 98% 63%',
  ...
  'neo-green': {
    light: {
      ...
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '260 60% 98%',
      [PRIMARY_VAR]: '133 31% 62%',
      [PRIMARY_FOREGROUND_VAR]: '260 60% 98%',
      [SECONDARY_VAR]: '133 31% 62%',
      [SECONDARY_FOREGROUND_VAR]: '260 60% 98%',
      [MUTED_VAR]: '133 31% 62%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '133 31% 62%',
      [ACCENT_FOREGROUND_VAR]: '260 60% 98%',
      [DESTRUCTIVE_VAR]: '0 62.8% 30.6%',
      [DESTRUCTIVE_FOREGROUND_VAR]: '260 60% 98%',
      [BORDER_VAR]: '133 31% 62%',
      [INPUT_VAR]: '133 31% 62%',
      [RING_VAR]: '35.5 91.7% 32.9%',
    },
    dark: {},
  ...
  'neo-blue': {
    light: {
      [BACKGROUND_VAR]: '60 89% 89%',
      [FOREGROUND_VAR]: '260 60% 98%',
      [CARD_VAR]: '20 14.3% 4.1%',
      [CARD_FOREGROUND_VAR]: '260 60% 98%',
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '260 60% 98%',
      [PRIMARY_VAR]: '197 71% 73%',
      [PRIMARY_FOREGROUND_VAR]: '260 60% 98%',
      [SECONDARY_VAR]: '197 71% 73%',
      [SECONDARY_FOREGROUND_VAR]: '260 60% 98%',
      [MUTED_VAR]: '197 71% 73%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '197 71% 73%',
      [ACCENT_FOREGROUND_VAR]: '260 60% 98%',
      [DESTRUCTIVE_VAR]: '0 62.8% 30.6%',
      [DESTRUCTIVE_FOREGROUND_VAR]: '260 60% 98%',
      [BORDER_VAR]: '197 71% 73%',
      [INPUT_VAR]: '197 71% 73%',
      [RING_VAR]: '35.5 91.7% 32.9%',
    },
    dark: {},
  ...
  'neo-yellow': {
    light: {
      [BACKGROUND_VAR]: '27 92% 95%',
      [FOREGROUND_VAR]: '26 83.3% 14.1%',
      [CARD_VAR]: '20 14.3% 4.1%',
      [CARD_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [PRIMARY_VAR]: '47 100% 67%',
      [PRIMARY_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [SECONDARY_VAR]: '47 100% 67%',
      [SECONDARY_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [MUTED_VAR]: '47 100% 67%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '47 100% 67%',
      [ACCENT_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [DESTRUCTIVE_VAR]: '0 62.8% 30.6%',
      [DESTRUCTIVE_FOREGROUND_VAR]: '26 83.3% 14.1%',
      [BORDER_VAR]: '47 100% 67%',
      [INPUT_VAR]: '47 100% 67%',
      [RING_VAR]: '35.5 91.7% 32.9%',
    },
    dark: {},
  ...
  'neo-rose': {
    light: {
      [BACKGROUND_VAR]: '0 86% 92%',
      [FOREGROUND_VAR]: '260 60% 98%',
      [CARD_VAR]: '20 14.3% 4.1%',
      [CARD_FOREGROUND_VAR]: '260 60% 98%',
      [POPOVER_VAR]: '20 14.3% 4.1%',
      [POPOVER_FOREGROUND_VAR]: '260 60% 98%',
      [PRIMARY_VAR]: '0 100% 71%',
      [PRIMARY_FOREGROUND_VAR]: '260 60% 98%',
      [SECONDARY_VAR]: '0 100% 71%',
      [SECONDARY_FOREGROUND_VAR]: '260 60% 98%',
      [MUTED_VAR]: '0 100% 71%',
      [MUTED_FOREGROUND_VAR]: '24 5.4% 63.9%',
      [ACCENT_VAR]: '0 100% 71%',
